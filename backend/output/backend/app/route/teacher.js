module.exports = (app) => { 
    ...
    app.get('/api/listTeacherDiscipline ', teacher.findAllDisciplines);

    app.post('/api/addTeacherDiscipline', teacher.createDiscipline);

    app.post('/api/deleteTeacherDiscipline/teacherId=:teacher_id/disciplineId=:discipline_id', teacher.deleteDiscipline);
}